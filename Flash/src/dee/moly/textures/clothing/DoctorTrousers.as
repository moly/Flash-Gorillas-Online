package dee.moly.textures.clothing {
	...
	/**
	 * White doctor trousers
	 * @author moly
	 */
	
	public class DoctorTrousers extends BitmapData{
		
		public function DoctorTrousers() {
			...
			fillRect(new Rectangle(4, 4, 5, 4), 0xFFFFFFFF);
			...
			fillRect(new Rectangle(18, 4, 5, 4), 0xFFFFFFFF);
