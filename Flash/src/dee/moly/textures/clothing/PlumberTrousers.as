package dee.moly.textures.clothing {
	...
	public class PlumberTrousers extends BitmapData{
		
		public function PlumberTrousers() {
			...
			fillRect(new Rectangle(4, 8, 5, 1), 0xFF462C1E);
			fillRect(new Rectangle(5, 9, 5, 1), 0xFF462C1E);
			...
			fillRect(new Rectangle(18, 8, 5, 1), 0xFF462C1E);
			fillRect(new Rectangle(17, 9, 5, 1), 0xFF462C1E);
		}
	}
}