package dee.moly.textures.clothing {
	...
	public class SuperTrousers extends BitmapData{
		...
		public function SuperTrousers() {
			...
			fillRect(new Rectangle(8, 2, 3, 1), 0xFFFD330F);
			fillRect(new Rectangle(16, 2, 3, 1), 0xFFFD330F);
			setPixel32(9, 3, 0xFFFD330F);
			setPixel32(17, 3, 0xFFFD330F);
			...
			fillRect(new Rectangle(4, 8, 5, 1), 0xFFFD330F);
			...
			fillRect(new Rectangle(18, 8, 5, 1), 0xFFFD330F);
